...
float* Audiofilter(float* signal,unsigned int size){
    ...
    float* filter = malloc(sizeof(float)*bufferlength);

    filter[0]  = bufferkoeffizient;
    filter[1]  = bufferkoeffizient;
    filter[2]  = bufferkoeffizient;
    filter[3]  = bufferkoeffizient;
    filter[4]  = bufferkoeffizient;
    filter[5]  = bufferkoeffizient;
    filter[6]  = bufferkoeffizient;
    filter[7]  = bufferkoeffizient;
    filter[8]  = bufferkoeffizient;
    filter[9]  = bufferkoeffizient;
    filter[10] = bufferkoeffizient;
    filter[11] = bufferkoeffizient;
    filter[12] = bufferkoeffizient;
    filter[13] = bufferkoeffizient;
    filter[14] = bufferkoeffizient;
    filter[14] = bufferkoeffizient;
    filter[15] = bufferkoeffizient;
    filter[16] = bufferkoeffizient;
    filter[17] = bufferkoeffizient;
    filter[18] = bufferkoeffizient;
    filter[19] = bufferkoeffizient;
